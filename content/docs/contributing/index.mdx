...
To learn more about our purpose and goals, please read the [README](/docs/about).

## Ground rules

Before contributing, read our [CODE OF CONDUCT](https://github.com/bettergovph/bettergov/blob/main/CODE_OF_CONDUCT.md) to learn more about our community guidelines and expectations.
...
For the complete guide, see [docs/Meilisearch.md](/docs/meilisearch).
