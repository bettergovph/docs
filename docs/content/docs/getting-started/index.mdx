...
This project uses Playwright for end-to-end testing. For setup instructions, coverage details, and examples, see our [Testing Guide](/docs/contributing/testing).
...
<a href="https://github.com/bettergovph/bettergov/graphs/contributors">
  <img src="https://contributors-img.web.app/image?repo=bettergovph/bettergov&max=750&columns=20" alt="Contributors" />
</a>

## Community

- **GitHub**: [bettergovph/bettergov](https://github.com/bettergovph/bettergov)
- **Discord**: [Join our community](https://discord.gg/mHtThpN8bT)

## Code of Conduct

We are committed to fostering a welcoming and respectful community. Please read our [Code of Conduct](/docs/contributing/code-of-conduct) before participating.
